	...
	return (
		<div className="w-full relative max-w-sm lg:max-w-full lg:p-5 lg:flex lg:flex-col lg:gap-20">
			...
			<div className="lg:flex lg:flex-row-reverse lg:relative">
				...
				<img src={CircleText} alt="You are enough image" className="hidden lg:block lg:absolute lg:-top-16 lg:-right-16 xl:-top-16 xl:right-4 animate-spin-slow" />
				<div className="xl:w-1/2 xl:py-14">
					<h2 className="w-[95%] text-4xl mx-auto font-playfairDisplay font-bold leading-[45px] xl:w-[80%] xl:mx-0 xl:text-5xl">
					...
					<button className="w-full p-5 text-xl rounded-full font-bold bg-customOrange text-customWhite lg:w-80 xl:p-4 hover:bg-opacity-80">
						Download Your Guide
					</button>
				</div>
			</div>
